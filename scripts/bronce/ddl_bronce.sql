...
IF OBJECT ID ('bronce.crm_cust_inf', 'u') IS NOT NULL
...
IF OBJECT ID ('bronce.crm_prd_inf', 'u') IS NOT NULL
...
IF OBJECT ID ('bronce.crm_sales_details', 'u') IS NOT NULL
...
IF OBJECT ID ('bronce.erp_cust_az12', 'u') IS NOT NULL
...
IF OBJECT ID ('bronce.erp_loc_a101', 'u') IS NOT NULL
...
IF OBJECT ID ('bronce.erp_px_cat_g1v2', 'u') IS NOT NULL
